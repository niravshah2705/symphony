...
test('planner binds exact forwarded headers and preserves A/B async isolation', async () => {
...
test('planner missing forwarded headers retains the legacy empty workspace', async () => {
...
test('planner refuses a forwarded project without its organization', async () => {
