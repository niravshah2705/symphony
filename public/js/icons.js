...
const ICON_PATHS = Object.freeze({
  ...
  paperclip: '<path d="M21.4 11.1 12.2 20.3a6 6 0 0 1-8.5-8.5l9.2-9.2a4 4 0 0 1 5.7 5.7l-9.2 9.2a2 2 0 0 1-2.9-2.9l8.5-8.5"/>',
...
export function hydrateIcons(root = document) {
  ...
  root.querySelectorAll('[data-brand-icon]').forEach((host) => {
    const name = host.dataset.brandIcon;
    const label = host.dataset.iconLabel || '';
    host.replaceChildren(brandIcon(name, { label }));
    if (!label) host.setAttribute('aria-hidden', 'true');
  });
}
