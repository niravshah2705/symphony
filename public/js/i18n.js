...
const MESSAGES = Object.freeze({
  en: {
    ...
    authDetails: 'You sign in with Google through Firebase; the gateway verifies your Firebase ID token before any workspace request reaches AI Fleet.',
  ...
  gu: {
    ...
    authDetails: 'તમે Firebase દ્વારા Google થી સાઇન ઇન કરો છો; કાર્યસ્થળની કોઈપણ વિનંતી AI Fleet સુધી પહોંચે તે પહેલાં ગેટવે તમારા Firebase ID ટોકનની ચકાસણી કરે છે.',
  ...
  hi: {
    ...
    authDetails: 'आप Firebase के ज़रिए Google से साइन इन करते हैं; किसी कार्यक्षेत्र अनुरोध के AI Fleet तक पहुँचने से पहले गेटवे आपके Firebase ID टोकन की जाँच करता है।',
